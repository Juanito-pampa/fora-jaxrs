...
public class UserDemoResource {
    ...
    public Response findUsers(@Context HttpServletResponse resp) throws Exception {

        String dir = System.getProperty("user.dir");
        URL resource = getClass().getResource("/");

        String p1 = resource.toURI().toString()+"../../index.html";

        java.nio.file.Path p = Paths.get(p1.replace("file:", ""));
        ...
        return Response.ok(resp.getOutputStream()).build();
